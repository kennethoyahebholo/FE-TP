  ...
  return (
    ...
    >
      <div className="flex flex-col items-center mb-0 md:mb-12">
        <p className="uppercase text-[8px] md:text-[16px] text-[#FFFFFF] font-medium text-center max-w-[530px]">
          join our community
        </p>
        ...
        <p className="capitalize text-[8px] md:text-[16px] text-[#FFFFFF] font-medium text-center max-w-[530px]">

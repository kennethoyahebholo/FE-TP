    ...
    <div className="w-full px-3 md:px-10 xl:px-32  pt-10 md:pt-28 pb-40 md:pb-60 flex justify-between bg-[#000F24]">
      <div className="w-full grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4">
        ...
        <div className="space-y-4 mb-6">
          <h4 className="text-2xl md:text-[32px] font-semibold text-white">
            Useful Links
          </h4>
          <div className="flex flex-col text-base lg:text-2xl text-white space-y-3">
            <Link to="#">Home</Link>
        ...
        <div className="space-y-4">
          ...
          <div className="flex text-sm max-w-[386px]">
            <input
              ...
              className="border border-[#054FB3] bg-[#2A2A2B] p-3 w-full"
            />
            <button
              type="button"
              className="bg-[#054FB3] text-white text-sm w-[123px] px-1"
            >
              Send Message
            </button>
          </div>

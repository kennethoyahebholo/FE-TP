...
const PopularCourses = ({ coursesRef }) => {
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center mb-4 md:mb-11">
        <h4 className="text-[24px] md:text-[42px] font-black text-[#000F24] text-center z-[2] capitalize">
          browse our popular courses
        </h4>
        <p className="capitalize text-[8px] md:text-base leading-4 text-[#A2A2A2] font-medium text-center max-w-[295px] md:max-w-[530px] z-[2]">
